...
/*void DRCStudy::SetChannels(vector<int> v_chs)
{


}*/
//void DRCStudy::SetChannels(vector<int> v_chs)
/*//histInfo DRCStudy::SetHistInfos(TString hName, TString hTitle, vector<double> v_entries)
{
...
void DRCStudy::SetChannels(string confName)
{
...
void DRCStudy::DeclareOptHistos(int idx, TString hName, TString hTitle, int NumBins, double xlow_, double xup_)
{
...
TH1D* DRCStudy::DeclareOptHistos( TString hName, TString hTitle, int NumBins, double xlow_, double xup_)
{
   //cout << "sk start DeclareOptHistos : " << hName << " hTitle : " << hTitle << " NumBins : " << NumBins << " xlow_ : " << xlow_ << " xup_ : " << xup_ << endl;
   TH1D* h_tmp;
...
TH1D* DRCStudy::DeclareOptHistos( TString hName, TString hTitle,  vector<double> v_entries)
{
   double min_  = -999.;
   int nBins_   = -999;
   double max_  = -999.;
...
void DRCStudy::SetOutputFileName(char *outname)
{   
   outfile = outname;
}

void DRCStudy::GetVariables()
{
   m_ch_adcs.clear();
   m_ch_adcs[0]=Ch0_ADC; 
   m_ch_adcs[1]=Ch1_ADC; 
